<div class="col-md-12 mb-4">
          ...
          <form class="row" target="_blank" method="POST" action="{{ route("admin.reports.cards.generate_debits") }}">
            {!! csrf_field() !!}
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-control-label">Created by</label>
                <select name="created_by" class="form-control debits-admin-list" v-model="debits.created_by" placeholder="Created by">
           ...
           <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="user_id" class="form-control debits-users-list" v-model="debits.user_id" placeholder="Select user">
                    <option value="all" selected="">All</option>

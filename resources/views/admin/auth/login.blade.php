     ...
     <div class="form-cc">
        <div class="col-sm-12 col-md-12">
         <div class="col-md-6 m-auto">
          ...
          <div class="userloginheading">Admin Login</div>
          </div>
          <x-guest-layout>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.login.post') }}">
                ...
                <div >
                    ...
                    <x-jet-input class="block mt-1 w-full {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text"
                ...
                <div class="form-group">
                    ...
                    <x-jet-input class="block mt-1 w-full form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" type="password"
                                 name="password" id="myInput" required autocomplete="current-password" />

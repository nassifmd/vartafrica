                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select required name="variety[]" id="variety" class="form-control" multiple>
                                        <option value="">Select</option>
                                        <option value="Mpologoma">Mpologoma</option>
                                        <option value="Kibuzi">Kibuzi</option>
                                        <option value="Kisansa">Kisansa</option>
                                        <option value="Mbwa zirume">Mbwa zirume</option>
                                        <option value="Ndizi">Ndizi</option>
                                        <option value="Bogoya">Bogoya</option>
                                        <option value="Nakitembe">Nakitembe</option>
                                        <option value="Musakala">Musakala</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="seed_quantity" class="form-control" type="text" name="seed_quantity" v-model="seed_quantity" value="{{ old('seed_quantity') }}" required />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label c
                                    lass="form-control-label">Unit Price (UGX)</label>
                                    <input @keyup="findTotal" id="unit_price" class="form-control" type="text" name="unit_price" v-model="unit_price" value="{{ old('unit_price') }}" required />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="total_price" class="form-control" type="text" name="total_price" v-model="total_price" value="{{ old('total_price') }}" required />
                                </div>
                            </div>

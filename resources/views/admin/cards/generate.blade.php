...
@section("content")
    ...
    <div class="col-md-12 mb-4">
          ...
          <div class="row">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" v-model="amount" placeholder="Select amount">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="form-control-label">Number of Cards</label>
                        <input class="form-control" type="number" v-model="num_of_cards" placeholder="Enter Number Of Cards">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6" v-if="(num_of_cards && amount && amount != 'Custom') || (amount == 'Custom' && customAmount)">
        ...
        methods: {
            getSerialCode () {
                ...
                axios({
                  ...
                  data: {
                    amount: this.amount == "Custom" ? this.customAmount : this.amount,
                    num_of_cards: this.num_of_cards
                  }

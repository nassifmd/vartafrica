...
<div class="container">
  ...
  <div class="login-contianer">
      <div class="bg_top">
      <img src="/img/logo1.png" style="margin-left: 180px; margin-top: 30px;" width="200px" alt="">
      </div>
     ...
     <div class="form-cc">
        <div class="col-sm-12 col-md-12">
         <div class="col-md-6 m-auto">
          ...
          <div class="userloginheading">Farmer Registeration</div>
          </div>
          <x-guest-layout>
        ...
        <form method="POST" action="{{ route('register') }}">
			...
			<div class="mt-2">
                ...
                <select name="country_code" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
					@foreach(\DB::table('countries')->get() as $countries)
                        <option value="{{ $countries->phonecode }}">+{{ $countries->phonecode }}</option>
                    @endforeach
				</select>
            </div>

            <div class="mt-4">
                <x-jet-label for="contact" value="{{ __('Mobile Number') }}" />
			...
			<div class="mt-4">
                ...
                <input id="age" class="block mt-1 w-full" type="date" name="age" value="{{ old('age') }}" required />
            </div>

			<div class="mt-4">
                <x-jet-label for="sex" value="{{ __('Sex') }}" />
                <select name="sex" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
					<option value="">Select</option>	
					<option value="male">Male</option>
					<option value="female" @if (old('Sex')== 2) selected @endif>Female</option>
				</select>
            </div>

			<div class="mt-4">
                <x-jet-label for="next_of_kin_name" value="{{ __('Name of Next of Kin') }}" />
                <x-jet-input id="next_of_kin_name" class="block mt-1 w-full" type="text" name="next_of_kin_name" :value="old('next_of_kin_name')" required />
            </div>

			<div class="mt-4">
                <x-jet-label for="next_of_kin_phone" value="{{ __('Mobile Number of Next of Kin') }}" />
                <x-jet-input id="next_of_kin_phone" class="block mt-1 w-full" type="text" name="next_of_kin_phone" :value="old('next_of_kin_phone')" required />
            </div>

  ...
  <div class="login-contianer">
     ...
     <div class="form-cc">
        <div class="col-sm-12 col-md-12">
         ...
         <div class="userloginheading">Farmer Login</div>
          </div>
          <x-guest-layout>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                <x-jet-label for="email" value="{{ __('Username / Phone Number') }}" />
                <x-jet-input id="email" class="block mt-1 w-full" type="text" name="email" :value="old('email')" required autofocus />
            </div>

            <div class="mt-4">
                <x-jet-label for="password" value="{{ __('Password') }}" />
                <x-jet-input id="password" class="block mt-1 w-full" id="myInput" type="password" name="password" required autocomplete="current-password" />
